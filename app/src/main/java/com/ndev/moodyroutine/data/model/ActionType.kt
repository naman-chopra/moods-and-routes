...
enum class ActionType(
    ...
    OPEN_APP("Open app or app action", "Launch an app or specific shortcut", "Launch", ActionCategory.APPS, true),
    CLOSE_APP("Close app", "Close a specific app", "Close", ActionCategory.APPS, true),
    RESTRICT_APPS("Restrict app usage", "Block distracting apps during this mode", "Block", ActionCategory.APPS, true),
    SET_WALLPAPER("Set wallpaper", "Change device wallpaper", "Wallpaper", ActionCategory.DISPLAY, true),
    SET_HOME_WALLPAPER("Home screen wallpaper", "Change Home screen wallpaper", "Wallpaper", ActionCategory.DISPLAY, true),
    SET_LOCK_WALLPAPER("Lock screen wallpaper", "Change Lock screen wallpaper", "LockScreen", ActionCategory.DISPLAY, true),
    WAIT_DELAY("Wait", "Wait before next action", "HourglassEmpty", ActionCategory.DEVICE, true),
